        ...
        <div className="room-details">
            <div className='grid-container'>
                <div className='room-type'>
                    ...
                    <h1>Standard Room</h1>
                    <p><span className='price'>$90.00</span> per Night</p>
                </div>
            ...
            <div className='room-images'>
                <img src='/images/room-3(2).jpeg' onClick={() => openLightbox('/images/room-3(2).jpeg')} />
                <img src='/images/room-3(3).jpeg' onClick={() => openLightbox('/images/room-3(3).jpeg')} />
                <img src='/images/room-3(4).jpeg' onClick={() => openLightbox('/images/room-3(4).jpeg')} />
                <img src='/images/room-3.jpeg' onClick={() => openLightbox('/images/room-3.jpeg')} />
            </div>
