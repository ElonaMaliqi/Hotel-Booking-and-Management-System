        ...
        <div className="room-details">
            <div className='grid-container'>
                <div className='room-type'>
                    ...
                    <h1>Superior Room</h1>
                    <p><span className='price'>$160.00</span> per Night</p>
                </div>
            ...
            <div className='room-images'>
                <img src='/images/room-2(2).jpeg' onClick={() => openLightbox('/images/room-2(2).jpeg')} />
                <img src='/images/room-2(3).jpeg' onClick={() => openLightbox('/images/room-2(3).jpeg')} />
                <img src='/images/room-2(4).jpeg' onClick={() => openLightbox('/images/room-2(4).jpeg')} />
                <img src='/images/room-2(5).jpeg' onClick={() => openLightbox('/images/room-2(5).jpeg')} />
            </div>
