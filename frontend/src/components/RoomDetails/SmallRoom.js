    ...
    return (
        <div className="room-details">
            ...
            <div className='room-images'>
                <img src='/images/room-6(2).jpeg' onClick={() => openLightbox('/images/room-6(2).jpeg')} />
                <img src='/images/room-6(3).jpeg' onClick={() => openLightbox('/images/room-6(3).jpeg')} />
                <img src='/images/room-6(4).jpeg' onClick={() => openLightbox('/images/room-6(4).jpeg')} />
                <img src='/images/room-6.jpeg' onClick={() => openLightbox('/images/room-6.jpeg')} />
            </div>
