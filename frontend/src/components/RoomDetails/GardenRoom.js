        ...
        <div className="room-details">
            <div className='grid-container'>
                <div className='room-type'>
                    ...
                    <h1>Garden Room</h1>
                    <p><span className='price'>$130.00</span> per Night</p>
                </div>
            ...
            <div className='room-images'>
                <img src='/images/room-5(2).jpeg' onClick={() => openLightbox('/images/room-5(2).jpeg')} />
                <img src='/images/room-5(3).jpeg' onClick={() => openLightbox('/images/room-5(3).jpeg')} />
                <img src='/images/room-5(4).jpeg' onClick={() => openLightbox('/images/room-5(4).jpeg')} />
                <img src='/images/room-5.jpeg' onClick={() => openLightbox('/images/room-5.jpeg')} />
            </div>
